...
public class ImageController {
    ...
    @PostMapping
    public ResponseEntity<Imagens> saveImage(@RequestPart SaveImageDTO saveImageDTO, @RequestPart MultipartFile image) {
        Imagens savedImage = imagemService.saveImage(saveImageDTO, image);
